...
*/
carro.adicionarPessoas = (n) => {
  const total = carro.quantidadePessoas + n;
  if (carro.quantidadePessoas === carro.assentos && total >= carro.assentos) {
    return "O carro já está lotado!";
  }else if (total > carro.assentos) {
    let sobra = carro.assentos - carro.quantidadePessoas;
    let pessoa = sobra === 1 ? "pessoa" : "pessoas";
