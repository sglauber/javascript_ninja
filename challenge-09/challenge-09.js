...
console.log(`O resultado da soma é: ${sum((a,b) => a + b)}`);
	...
	*/
	...
	chamada.
	*/
	const sub = calculator(30, 3);
	console.log(`O resultado da subtração é: ${sub((a, b) => a - b)}`);
	// ?
	const multi = calculator(20, 5)
	console.log(`O resultado da multiplicação é: ${multi((a, b) => a * b)}`);

	const divi = calculator(24, 3)
	console.log(`O resultado da multiplicação é: ${divi((a, b) => a / b)}`);

	const mod = calculator(10, 2)
	console.log(`O resultado da multiplicação é: ${mod((a, b) => a % b)}`);
})();