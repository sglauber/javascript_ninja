...
*/
const showOperationMessage = (operator, a, b) => {
...
*/
if(sum) {
  console.log(showOperationMessage(operationSignal, number1 = 2, number2 = 3), sum(number1, number2));
} else {
...
operationSignal = '-';
const sub = calculator(operationSignal)

if(sub) {
  console.log(showOperationMessage(operationSignal, number1 = 4, number2 = 3), sub(number1, number2));
} else {
  console.log(showErrorMessage(operationSignal));
}

operationSignal = '*';
const mut = calculator(operationSignal)

if(mut) {
  console.log(showOperationMessage(operationSignal, number1 = 4, number2 = 3), mut(number1, number2));
} else {
  console.log(showErrorMessage(operationSignal));
}

operationSignal = '/';
const div = calculator(operationSignal)

if(div) {
  console.log(showOperationMessage(operationSignal, number1 = 4, number2 = 3), div(number1, number2));
} else {
  console.log(showErrorMessage(operationSignal));
}

operationSignal = '.';
const inv = calculator(operationSignal)

if(inv) {
  console.log(showOperationMessage(operationSignal, number1 = 4, number2 = 3), inv(number1, number2));
} else {
  console.log(showErrorMessage(operationSignal));
}

operationSignal = '%';
const rest = calculator(operationSignal)

if(rest) {
  console.log(showOperationMessage(operationSignal, number1 = 4, number2 = 3), rest(number1, number2));
} else {
  console.log(showErrorMessage(operationSignal));
}
